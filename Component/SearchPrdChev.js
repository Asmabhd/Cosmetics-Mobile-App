...
import PrdListChev from "./PrdListChev";
import { Searchbar } from "react-native-paper";
import { connect } from "react-redux";
import { SafeAreaView } from "react-native-safe-area-context";
import CustomHeader from "./CustomHeader";

class SearchPrdChev extends Component {
  constructor(props) {
    super(props);
    this.state = {
      produit: [],
  ...
  componentDidMount() {
    const url = "https://asmabh.herokuapp.com/api/cat%C3%A9gorieByprd/2";
...
export default connect(mapStateToProps)(SearchPrdChev);
