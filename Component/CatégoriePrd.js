  ...
  render() {
    return (
      <View style={{ flex: 1, justifyContent: "center" }}>
        ...
        >
          <TouchableOpacity
            onPress={() => this.props.navigation.navigate("SearchPrdVisage")}
          >
            <Image
        ...
        >
          <TouchableOpacity
            onPress={() => this.props.navigation.navigate("SearchPrdChev")}
          >
            <Image
              style={styles.categoriesPhoto}
              source={{
        ...
        >
          <TouchableOpacity
            onPress={() => this.props.navigation.navigate("SearchPrdCorps")}
          >
            <Image
              style={styles.categoriesPhoto}
              source={{
