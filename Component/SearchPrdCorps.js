...
import PrdListCorps from "./PrdListCorps";
import { Searchbar } from "react-native-paper";
import { connect } from "react-redux";
import { SafeAreaView } from "react-native-safe-area-context";
import CustomHeader from "./CustomHeader";

class SearchPrdCorps extends Component {
  constructor(props) {
    super(props);
    this.state = {
      produit: [],
  ...
  componentDidMount() {
    const url = "https://asmabh.herokuapp.com/api/cat%C3%A9gorieByprd/3";
...
export default connect(mapStateToProps)(SearchPrdCorps);
